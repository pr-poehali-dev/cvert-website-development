...
const Index = () => {
  ...
  const tabContent = {
    ...
    contracts: {
      ...
      points: [
        'ООО "КИБЕРСТАЛЬ" — поставка и монтаж осушителей сжатого воздуха',
        'ООО "ГАЗПРОМ НЕФТЬ" — комплексные решения для производственных объектов',
        'МНПЗ (Московский НПЗ) — установка водородных станций',
        'Более 50 реализованных проектов по всей России',
